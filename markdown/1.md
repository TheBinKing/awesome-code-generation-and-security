...
#### [DeepSeek] DeepSeek-V3.2: Pushing the Frontier of Open Large Language Models
...
#### [DeepSeek] DeepSeek-V3.1-Terminus
 ...
 [[project]](https://huggingface.co/deepseek-ai/DeepSeek-V3.1-Terminus)

---

#### [DeepSeek] DeepSeek-V3.1

 [[project]](https://huggingface.co/deepseek-ai/DeepSeek-V3.1)

---

#### [arxiv'25] PANGU ULTRA: PUSHING THE LIMITS OF DENSE LARGE LANGUAGE MODELS ON ASCEND NPUS

[[paper]](https://arxiv.org/abs/2504.07866v2)
...
#### [Mi] MiMo-V2-Flash Technical Report

[[paper]](https://github.com/XiaomiMiMo/MiMo-V2-Flash/blob/main/paper.pdf) [[project]](https://huggingface.co/XiaomiMiMo/MiMo-V2-Flash)
...
[[paper]](https://cdn.openai.com/pdf/3a4153c8-c748-4b71-8e31-aecbde944f8d/oai_5_2_system-card.pdf)
...
[[paper]](https://www-cdn.anthropic.com/4263b940cabb546aa0e3283f35b686f4f3b2ff47.pdf)

<details>
  <summary>Click to see the abstract!</summary>
> This document is a System Card Addendum accompanying the release of Claude Opus 4.1, an incremental update to Anthropic's large language model Claude Opus 4. It supplements the comprehensive Claude 4 system card published in May 2025, which details safety evaluation methodologies, threat models, and testing frameworks. Claude Opus 4.1 features incremental improvements in reasoning quality, instruction-following, and overall performance, and is deployed under the AI Safety Level 3 (ASL-3) Standard per Anthropic's Responsible Scaling Policy (RSP) as a precautionary measure. Since it does not meet the "notably more capable" criteria relative to Claude Opus 4, mandatory RSP evaluations were not required, but voluntary automated testing was conducted to track capability progression and validate safety assumptions. The addendum presents key evaluations including safeguards results (single-turn evaluations for violative/benign requests, child safety, bias), agentic safety (malicious computer use, prompt injection, malicious agentic coding), alignment and welfare assessments, reward hacking tendencies, and RSP evaluations (CBRN, autonomy, cyber). It aims to provide transparency on the model's capabilities, limitations, and risk profile, while noting that permissible uses are governed by Anthropic's Usage Policy and applicable terms of service.
</details>

---

#### [Anthropic] System Card Addendum: Claude Opus 4.1

[[paper]](https://assets.anthropic.com/m/4c024b86c698d3d4/original/Claude-4-1-System-Card.pdf)
...
#### [Google] Gemini 2.5 Flash & 2.5 Flash Image Model Card

[[paper]](https://storage.googleapis.com/deepmind-media/Model-Cards/Gemini-2-5-Flash-Model-Card.pdf)

---

#### [Google] Gemini 2.5 Flash-Lite Model Card

[[paper]](https://storage.googleapis.com/deepmind-media/Model-Cards/Gemini-2-5-Flash-Lite-Model-Card.pdf)

---
#### [Google] Gemini 2.5 Deep Think Model Card

[[paper]](https://storage.googleapis.com/deepmind-media/Model-Cards/Gemini-2-5-Deep-Think-Model-Card.pdf)

---
#### [Google] Gemini 2.5 Computer Use Model Card

[[paper]](https://storage.googleapis.com/deepmind-media/Model-Cards/Gemini-2-5-Computer-Use-Model-Card.pdf)

---
#### [Google] Gemini 2.5 Pro Model Card

[[paper]](https://modelcards.withgoogle.com/assets/documents/gemini-2.5-pro.pdf)
...
[[paper]](https://cdn.openai.com/pdf/2221c875-02dc-4789-800b-e7758f3722c1/o3-and-o4-mini-system-card.pdf)

---

#### [Google] Gemini Diffusion

[[web]](https://deepmind.google/models/gemini-diffusion/)

---

#### [Anthropic] Claude 3.7 Sonnet System Card

[[paper]](https://assets.anthropic.com/m/785e231869ea8b3b/original/claude-3-7-sonnet-system-card.pdf)
...
#### [DeepSeek] DeepSeek-V2.5
 ...
 [[project]](https://huggingface.co/deepseek-ai/DeepSeek-V2.5)

---

#### [arxiv'24] DeepSeek-V2: A Strong, Economical, and Efficient Mixture-of-Experts Language Model

[[paper]](https://arxiv.org/pdf/2405.04434v5.pdf) [[project]](https://github.com/deepseek-ai/DeepSeek-V2)
...
#### [arxiv'24] DeepSeekMoE: Towards Ultimate Expert Specialization in Mixture-of-Experts Language Models

[[paper]](https://arxiv.org/abs/2401.06066v1) [[project]](https://github.com/deepseek-ai/DeepSeek-MoE)
...
#### [arxiv'24] DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models

[[paper]](https://arxiv.org/pdf/2402.03300v3.pdf) [[project]](https://github.com/deepseek-ai/DeepSeek-Math)
...
#### [arxiv'24] DeepSeek LLM: Scaling Open-Source Language Models with Longtermism

[[paper]](https://arxiv.org/abs/2401.02954v1)
...
[[paper]](https://arxiv.org/pdf/2408.00118v3.pdf)

<details>
  <summary>Click to see the abstract!</summary>
> We introduce Gemma 2, a new addition to the Gemma family of lightweight, state-of-the-art open language models, ranging in scale from 2 billion to 27 billion parameters. In this version, we apply several technical modifications to the Transformer architecture, including interleaving local-global attentions and group-query attention. We train the 2B and 9B models with knowledge distillation instead of next token prediction, while releasing a 27B model trained from scratch. The resulting models deliver the best performance for their size and even offer competitive alternatives to models that are 2-3× bigger. We provide an overview of the models' architecture, training, pre- and post-training recipes, and conduct detailed evaluations across quantitative, qualitative, academic benchmarks and human-preference evaluations. We also discuss approaches to safe and responsible deployment, along with the models' limitations and advantages, and release all models to the community.
</details>

---

#### [Google] Gemma: Open Models Based on Gemini Research and Technology

[[paper]](https://arxiv.org/pdf/2403.08295v4.pdf)

<details>
  <summary>Click to see the abstract!</summary>
> This work introduces Gemma, a family of lightweight, state-of-the-art open models built from the research and technology used to create Gemini models. Gemma models demonstrate strong performance across academic benchmarks for language understanding, reasoning, and safety. The family includes two sizes of models (2 billion and 7 billion parameters), with both pretrained and fine-tuned checkpoints provided. Gemma outperforms similarly sized open models on 11 out of 18 text-based tasks. The work presents comprehensive evaluations of the models' safety and responsibility aspects, alongside a detailed description of model development—including architecture (based on the transformer decoder with improvements like Multi-Query Attention, RoPE Embeddings, GeGLU Activations, and RMSNorm), training infrastructure (using TPUv5e pods), pretraining data (3T tokens for 2B, 6T tokens for 7B, primarily English), instruction tuning (via supervised fine-tuning and reinforcement learning from human feedback), and memorization assessments. Google DeepMind emphasizes the importance of responsible LLM release for improving frontier model safety and enabling LLM innovations, and provides a Generative AI Responsible Toolkit to support developers in building responsibly.
</details>
...
[[paper]](https://www-cdn.anthropic.com/fed9cc193a14b84131812372d8d5857f8f304c52/Model_Card_Claude_3_Addendum.pdf)


---

#### [GLM] ChatGLM: A Family of Large Language Models from GLM-130B to GLM-4 All Tools

[[paper]](https://arxiv.org/pdf/2406.12793v2.pdf) [[project]](https://github.com/THUDM)
...
[[project]](https://github.com/zai-org/GLM-4)
...
[[web]](https://www.llama.com/docs/model-cards-and-prompt-formats/llama4/)

---

#### [Meta] Llama Guard 4

[[project]](https://github.com/meta-llama/PurpleLlama/blob/main/Llama-Guard4/12B/MODEL_CARD.md)

---

#### [Meta] Llama Guard 3

[[project]](https://github.com/meta-llama/PurpleLlama/blob/main/Llama-Guard3/README.md)

---

#### [Meta] Llama 3.3

[[project]](https://github.com/meta-llama/llama-models/blob/main/models/llama3_3/MODEL_CARD.md)

---

#### [Meta] Llama 3.2

[[web]](https://www.llama.com/docs/model-cards-and-prompt-formats/llama3_2/)

---

#### [Meta] Llama 3.1

[[project]](https://github.com/meta-llama/llama-models/blob/main/models/llama3_1/MODEL_CARD.md)

---

#### [Meta] Llama Guard 2

[[project]](https://github.com/meta-llama/PurpleLlama/blob/main/Llama-Guard2/MODEL_CARD.md)
...
#### [Anthropic] Claude 3 Model Family: Opus, Sonnet, Haiku

[[paper]](https://www-cdn.anthropic.com/f2986af8d052f26236f6251da62d16172cfabd6e/claude-3-model-card.pdf)
...
[[project]](https://x.ai/news/grok-3)

---

#### [xAI] Grok-2

[[project]](https://huggingface.co/xai-org/grok-2)

---

#### [xAI] Grok-1

[[project]](https://github.com/xai-org/grok-1)

---

### 2023

#### [arxiv'23] PANGU-Σ: TOWARDS TRILLION PARAMETER LANGUAGE MODEL WITH SPARSE HETEROGENEOUS COMPUTING TECHNICAL REPORT

[[paper]](https://arxiv.org/abs/2303.10845v1)
...
[[web]](https://qwenlm.github.io/zh/blog/qwen1.5/)

---

#### [Meta] Llama Guard: LLM-based Input-Output Safeguard for Human-AI Conversations

[[paper]](https://scontent-sin2-1.xx.fbcdn.net/v/t39.2365-6/408725049_3688557441468029_8103913771964668529_n.pdf?_nc_cat=100&ccb=1-7&_nc_sid=3c67a6&_nc_ohc=cMqVKDvo63UQ7kNvwGzkc6_&_nc_oc=AdnHvcHjYBykUFqmQzaoKxTw7JirvbW1Z4wD7qG22RH4RWOLc7XZxKlr41VmN1Fdjl8&_nc_zt=14&_nc_ht=scontent-sin2-1.xx&_nc_gid=3MQ4HTUFGk9HsmCguoRq6w&oh=00_AfkHpCWxOJYeNUrXPF6TSAk4Z_toFf72lF9kD0Geym2KKA&oe=694FCD59) [[project]](https://github.com/meta-llama/PurpleLlama/blob/main/Llama-Guard/MODEL_CARD.md)
...
[[project]](https://github.com/zai-org/ChatGLM3)

---

#### [Github] ChatGLM2-6B

[[project]](https://github.com/zai-org/ChatGLM2-6B)

---

#### [Github] ChatGLM-6B

[[project]](https://github.com/zai-org/ChatGLM-6B)

---

#### [Anthropic] Model Card and Evaluations for Claude Models

[[paper]](https://www-cdn.anthropic.com/files/4zrzovbb/website/bd2a28d2535bfb0494cc8e2a3bf135d2e7523226.pdf)
...
[[web]](https://crfm.stanford.edu/2023/03/13/alpaca.html) [[project]](https://github.com/tatsu-lab/stanford_alpaca) 
...
[[paper]](https://arxiv.org/pdf/2006.03654v6.pdf) [[project]](https://github.com/microsoft/DeBERTa)
...
#### [arxiv'19] Transformer-XL: Attentive Language Models Beyond a Fixed-Length Context

[[paper]](https://arxiv.org/pdf/1901.02860v3.pdf) [[project]](https://github.com/kimiyoung/transformer-xl)
...
#### [OpenAI] Release Strategies and the Social Impacts of Language Models

[[paper]](https://openai.com/research/release-strategies-and-social-impacts-of-language-models)
...
#### [OpenAI] Addendum to GPT-5.2 System Card: GPT-5.2-Codex

[[paper]](https://cdn.openai.com/pdf/ac7c37ae-7f4c-4442-b741-2eabdeaf77e0/oai_5_2_Codex.pdf)

---

#### [Qwen] Qwen3-Coder

[[web]](https://qwenlm.github.io/blog/qwen3-coder/) [[project]](https://github.com/QwenLM/Qwen3-Coder)

---

#### [HuggingFace] Devstral

[[project]](https://huggingface.co/mistralai/Devstral-Small-2505)
...
[[web]](https://docs.mistral.ai/models/codestral-25-08)
...
#### [ACL'24] OpenCodeInterpreter: Integrating Code Generation with Execution and Refinement

[[paper]](https://aclanthology.org/2024.findings-acl.762/) [[project]](https://opencodeinterpreter.github.io)
...
#### [NeurIPS'24] SWE-agent: Agent-Computer Interfaces Enable Automated Software Engineering

[[paper]](https://arxiv.org/pdf/2405.15793v3.pdf) [[project]](https://swe-agent.com)
...
[[project]](https://huggingface.co/ibm-granite/granite-8b-code-instruct-128k)

---

#### [Github] CodeGeeX4

[[project]](https://github.com/zai-org/CodeGeeX4)
...
[[project]](https://huggingface.co/Qwen/CodeQwen1.5-7B)

---

#### [Github] CodeGeeX2

[[project]](https://github.com/zai-org/CodeGeeX2)

---

#### [ICLR'23] CODEGEN2: LESSONS FOR TRAINING LLMS ON PROGRAMMING AND NATURAL LANGUAGES
[[paper]](https://arxiv.org/pdf/2305.02309v2.pdf) [[project]](https://github.com/salesforce/CodeGen)
...
#### [Google] AlphaCode 2 Technical Report
...
#### [arxiv'22] PANGU-CODER: Program Synthesis with Function-Level Language Modeling TECHNICAL REPORT

[[paper]](https://arxiv.org/pdf/2207.11280v1.pdf)
...
[[paper]](https://arxiv.org/pdf/2005.08025)  [[talk]](https://www.youtube.com/watch?v=sQpv_WY8n04)
...
#### [arxiv'26] Rethinking the Evaluation of Secure Code Generation

[[paper]](https://arxiv.org/pdf/2503.15554v2.pdf)
...
[[paper]](https://arxiv.org/pdf/2508.14925v1.pdf) [[project]](https://anonymous.4open.science/r/AAAI26-7C02)
...
#### [arxiv'25] PaperBench: Evaluating AI's Ability to Replicate AI Research

[[paper]](https://arxiv.org/pdf/2504.01848v3.pdf)
...
#### [ICML'25] BAXBENCH: Can LLMs Generate Correct and Secure Backends?

[[paper]](https://arxiv.org/pdf/2502.11844v3.pdf) [[project]](https://baxbench.com/)
...
---
#### [ICML'25] SWE-Lancer: Can Frontier LLMs Earn $1 Million from Real-World Freelance Software Engineering?

[[paper]](https://arxiv.org/pdf/2502.12115v4.pdf) [[project]](https://github.com/openai/SWELancer-Benchmark)
...
---
#### [arxiv'25] Benchmarking LLMs and LLM-based Agents in Practical Vulnerability Detection for Code Repositories

[[paper]](https://arxiv.org/pdf/2503.03586v2.pdf)
...
---
#### [arxiv'25] FEA-Bench: A Benchmark for Evaluating Repository-Level Code Generation for Feature Implementation

[[paper]](https://arxiv.org/pdf/2503.06680v2.pdf) [[project]](https://github.com/microsoft/FEA-Bench)
...
#### [arxiv'24] CodeMirage: Hallucinations in Code Generated by Large Language Models

[[paper]](https://arxiv.org/pdf/2408.08333v2.pdf)
...
#### [arxiv'25] What is Wrong with Your Code Generated by Large Language Models? An Extensive Study

[[paper]](https://arxiv.org/pdf/2407.06153v2.pdf)
...
#### [ICLR'25] MLE-Bench: Evaluating Machine Learning Agents on Machine Learning Engineering

[[paper]](https://arxiv.org/pdf/2410.07095v6.pdf) [[project]](https://github.com/openai/mle-bench)
...
#### [AAAI'25] CodeHalu: Investigating Code Hallucinations in LLMs via Execution-based Verification

[[paper]](https://arxiv.org/pdf/2405.00253v4.pdf) [[project]](https://github.com/yuchen814/CodeHalu)
...
#### [arxiv'25] LeetCodeDataset: A Temporal Dataset for Robust Evaluation and Efficient Training of Code LLMs

[[paper]](https://arxiv.org/pdf/2504.14655v1.pdf) [[project]](https://huggingface.co/datasets/newfacade/LeetCodeDataset) [[Github]](https://github.com/newfacade/LeetCodeDataset)
...
#### [ICML'25] CVE-Bench: A Benchmark for AI Agents’ Ability to Exploit Real-World Web Application Vulnerabilities

[[paper]](https://arxiv.org/pdf/2503.17332v4.pdf) [[project]](https://github.com/uiuc-kanglab/cve-bench)
...
#### [Qwen] CODEELO: Benchmarking Competition-level Code Generation of LLMs with Human-comparable Elo Ratings

[[paper]](https://arxiv.org/pdf/2501.01257v2.pdf) [[project]](https://CodeElo-bench.github.io) [[project]](https://hf.co/datasets/Qwen/CodeElo)
...
#### [arxiv'24] Exploring and Evaluating Hallucinations in LLM-Powered Code Generation

[[paper]](https://arxiv.org/pdf/2404.00971)
...
[[project]](https://github.com/AI-secure/RedCode)
...
#### [arxiv'24] RMCBench: Benchmarking Large Language Models’ Resistance to Malicious Code

[[paper]](https://arxiv.org/pdf/2409.15154v1.pdf) [[project]](https://github.com/qingyuan233/RMCBench)
...
#### [arxiv'24] Is Your AI-Generated Code Really Safe? Evaluating Large Language Models on Secure Code Generation with CodeSecEval

[[paper]](https://arxiv.org/pdf/2407.02395v2.pdf)
...
#### [arxiv'24] CRUXEval: A Benchmark for Code Reasoning, Understanding and Execution

[[paper]](https://arxiv.org/pdf/2401.03065v1.pdf)
...
#### [arxiv'24] CodeScope: An Execution-based Multilingual Multitask Multidimensional Benchmark for Evaluating LLMs on Code Understanding and Generation

[[paper]](https://arxiv.org/pdf/2311.08588v3.pdf) [[project]](https://github.com/WeixiangYAN/CodeScope)
...
#### [arxiv'24] Can LLM Replace Stack Overflow? A Study on Robustness and Reliability of Large Language Model Code Generation

[[paper]](https://arxiv.org/pdf/2308.10335v5.pdf) [[project]](https://github.com/FloridSleeves/RobustAPI)
...
#### [ICLR'24] SWE-BENCH: CAN LANGUAGE MODELS RESOLVE REAL-WORLD GITHUB ISSUES?

[[paper]](https://arxiv.org/pdf/2310.06770) [[project]](https://github.com/SWE-bench/SWE-bench)
...
#### [ICLR'23] Multi-Lingual Evaluation of Code Generation Models

[[project]](https://github.com/amazon-research/mbxp-exec-eval)
...
[[paper]](https://doi.org/10.1145/3576915.3623157)
...
[[paper]](https://arxiv.org/pdf/2305.12865v1.pdf)
...
#### [arxiv'23] An Empirical Evaluation of Using Large Language Models for Automated Unit Test Generation

[[paper]](https://arxiv.org/pdf/2302.06527v4.pdf) [[project]](https://github.com/githubnext/testpilot)
...
#### [arXiv'23] Enhancing Large Language Models for Secure Code Generation: A Dataset-driven Study on Vulnerability Mitigation
...
#### [arxiv'22] BBQ: A Hand-Built Bias Benchmark for Question Answering

[[paper]](https://arxiv.org/pdf/2110.08193v2.pdf) [[project]](https://github.com/nyu-mll/BBQ)
...
#### [arxiv'22] Discovering Language Model Behaviors with Model-Written Evaluations

[[paper]](https://arxiv.org/pdf/2212.09251) [[project]](https://github.com/anthropics/evals)
